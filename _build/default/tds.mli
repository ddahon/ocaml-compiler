...
type info =
  ...
  (* Information associée à une fonction : son nom (utile pour l'appel), son type de retour, la liste des types des paramètres et un entier indiquant le numero de la surcharge (commence à 0) *)
...
(* Recherche la liste des informations des fonctions définies avec le même nom (surcharge) dans la tds globale *)
(* string : le nom de la fonction *)
(* Retourne la liste des informations associées aux fonctions définies avec le nom donné *)
(* Retourne None si cette fonction n'est pas encore définie *)
val chercherGlobalementFonction : tds -> string -> (info_ast list) option
